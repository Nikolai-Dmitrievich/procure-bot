...
class CustomUserAdmin(UserAdmin):
    ...
    add_fieldsets = UserAdmin.add_fieldsets + (
        (
            ...
            {
                'fields': (
                    'company', 'position', 'type', 'email_verified',
                    'is_social_user', 'avatar'
                ),
                'classes': ('wide',)
            }
        ),
    ...
    list_display = (
        ...
        'is_staff', 'email_verified', 'get_avatar_preview',
    )
    list_filter = [
        'type', 'email_verified', 'is_social_user', 'is_staff', 'is_active'
    ]
